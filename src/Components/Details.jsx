        ...
        <div>
            <div className="hero min-h-screen p-0 mt-12">
                <div className="hero-content flex-col lg:flex-row gap-12 h-full rounded-2xl">
                    <div className="bg-[#1313130D] w-11/12 lg:w-2/5 h-full object-cover flex justify-center items-center rounded-2xl">
                        <img src={book.image} />
                    </div>
                    <div className="w-11/12 lg:w-3/5 flex flex-col gap-4">
                        <h2 className="text-2xl lg:text-5xl font-bold">{book.bookName}</h2>
                        ...
                        <hr />
                        <p className="text-base lg:text-lg font-medium text-[#3b3b3bcc]">Number of Pages : 
                         <span className="text-black font-semibold ml-4">{book.totalPages}</span></p>
                        <p className="text-base lg:text-lg font-medium text-[#3b3b3bcc]">Publisher :
                        <span className="text-black font-semibold ml-4">{book.publisher}</span></p>
                        <p className="text-base lg:text-lg font-medium text-[#3b3b3bcc]">Year of Publishing : 
                        <span className="text-black font-semibold ml-4">{book.yearOfPublishing}</span></p>
                        <p className="text-base lg:text-lg font-medium text-[#3b3b3bcc]">Rating : 
